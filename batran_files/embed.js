...
},{"./GetIntrinsic":5,"./helpers/isFinite":7,"./helpers/isNaN":8,"./helpers/mod":9,"./helpers/sign":10,"es-to-primitive/es5":11,"has":17,"is-callable":20}],7:[function(require,module,exports){
...
},{"is-callable":20}],14:[function(require,module,exports){
'use strict';
...
},{"function-bind":15}],18:[function(require,module,exports){
...
var Instrumentile = L.Class.extend({
    ...
    initialize: function(map, options) {
        ...
        map.tileLayer.on({
            'tileloadstart': this._tileloadstart,
            'tileload': this._tileload
        }, this);
    },
    ...
    _tileload: function(e) {
        var tileUrl = e.tile.src;
        var host = tileUrl.match(/https?:\/\/([a-z])\..*/);
        var duration, DNS, TCP, SSL, request, response;
        var p = (window.performance && performance.getEntriesByName) ?
            performance.getEntriesByName(tileUrl)[0] : undefined;
        ...
        if (p){
            ...
            response = p.responseEnd - p.responseStart;
            duration = p.duration;
        } else if (tileUrl in this.tileStats) duration = this._performance() -
            this.tileStats[tileUrl].tileloadstart;
        else return;

        this.tileStats[tileUrl].tileloadtime = duration;
        this.events.push({
...
},{"mapbox-events":26}],20:[function(require,module,exports){
'use strict';
...
},{"./compatibility_post.js":25,"./post.js":27,"hat":18,"lodash-compat":24,"xhr":64}],27:[function(require,module,exports){
module.exports = function(events, callback) {
...
window.onload = function() {
    ...
    // horrible fix to work around an issue with multiple embeds on a page (#2893)
    document.getElementsByTagName("html")[0].style.height =
        document.body.style.height = document.getElementById('map').style.height = '100%';
    ...
    if (include('geocoder')) map.addControl(L.mapbox.geocoderControl('mapbox.places'));
    if (include('share')) map.addControl(L.mapbox.shareControl(tilejson));
    if (include('attribution')) map.attributionControl.addAttribution(L.mapbox.sanitize(tilejson.attribution));
};


},{"instrumentile":19,"leaflet-hash":22,"mapbox.js":41,"underscore":28}],30:[function(require,module,exports){
...
},{"./format_url":35,"./marker":49,"./request":50,"./simplestyle":52,"./util":55,"sanitize-caja":58}],34:[function(require,module,exports){
'use strict';
...
},{"../package.json":31,"./config":32}],36:[function(require,module,exports){
'use strict';
...
},{"./feedback":34,"./format_url":35,"./request":50,"./util":55,"isarray":30}],37:[function(require,module,exports){
'use strict';
...
},{"./geocoder":36,"./util":55}],38:[function(require,module,exports){
'use strict';
...
},{"./util":55,"mustache":56,"sanitize-caja":58}],40:[function(require,module,exports){
'use strict';
...
},{"./grid":38,"./load_tilejson":45,"./request":50,"./util":55}],41:[function(require,module,exports){
'use strict';
...
},{"./leaflet":43,"./mapbox":47}],42:[function(require,module,exports){
'use strict';
...
},{"sanitize-caja":58}],43:[function(require,module,exports){
module.exports = window.L = require('leaflet/dist/leaflet-src');

},{"leaflet/dist/leaflet-src":23}],44:[function(require,module,exports){
'use strict';
...
},{"sanitize-caja":58}],45:[function(require,module,exports){
'use strict';
...
},{"./format_url":35,"./request":50,"./util":55}],46:[function(require,module,exports){
'use strict';
...
},{"./feature_layer":33,"./feedback":34,"./grid_control":39,"./grid_layer":40,"./info_control":42,"./legend_control":44,"./load_tilejson":45,"./mapbox_logo":48,"./share_control":51,"./tile_layer":54,"sanitize-caja":58}],47:[function(require,module,exports){
'use strict';
...
},{"../package.json":31,"./config":32,"./feature_layer":33,"./feedback":34,"./geocoder":36,"./geocoder_control":37,"./grid_control":39,"./grid_layer":40,"./info_control":42,"./legend_control":44,"./map":46,"./marker":49,"./share_control":51,"./simplestyle":52,"./style_layer":53,"./tile_layer":54,"mustache":56,"sanitize-caja":58}],48:[function(require,module,exports){
'use strict';
...
},{"./format_url":35,"./util":55,"sanitize-caja":58}],50:[function(require,module,exports){
'use strict';
...
},{"./config":32,"./util":55,"corslite":1}],51:[function(require,module,exports){
'use strict';
...
},{"./format_url":35,"./load_tilejson":45}],52:[function(require,module,exports){
'use strict';
...
},{"./format_url":35,"./request":50,"./util":55,"sanitize-caja":58}],54:[function(require,module,exports){
'use strict';
...
},{"./load_tilejson":45,"./util":55,"sanitize-caja":58}],55:[function(require,module,exports){
'use strict';
...
},{"for-each":13,"string.prototype.trim":61}],58:[function(require,module,exports){
...
},{"./sanitizer-bundle.js":59}],59:[function(require,module,exports){
...
},{"es-abstract/es5":6,"function-bind":15}],61:[function(require,module,exports){
'use strict';
...
},{"./implementation":60,"./polyfill":62,"./shim":63,"define-properties":2,"function-bind":15}],62:[function(require,module,exports){
'use strict';
...
},{"./polyfill":62,"define-properties":2}],64:[function(require,module,exports){
"use strict";
...
},{"global/window":16,"is-function":21,"parse-headers":57,"xtend":65}],65:[function(require,module,exports){
